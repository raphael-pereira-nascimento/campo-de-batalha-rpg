...
export const MONSTERS = {
  ...
  zumbi: {
    ...
    spells: [],
    passiva: 'Morto-vivo: resiste a morrer 1 vez por batalha.',
  ...
  golem_pedra: {
    ...
    spells: ['muralha'],
    passiva: 'Colosso: atinge vários inimigos e não pode ser derrubado facilmente.',
    efeitos: { danoFisicoMult: 1.15 },
    escalaChefe: true,
    multiplicadorHP: 2.5,
  },
  ...
  goblin: {
    ...
    spells: [],
    passiva: 'Ligeiro: esquiva 15% mais.',
    efeitos: { esquivaBonus: 0.15 },
  },
  lobo: {
    id: 'lobo',
    nome: 'Lobo',
    ...
    spells: [],
    passiva: 'Alcateia: ataca em bando.',
    efeitos: {},
  },
  bandido: {
    id: 'bandido',
  ...
  gigante: {
    ...
    spells: [],
    passiva: 'Força bruta: causa 10% a mais de dano físico.',
    efeitos: { danoFisicoMult: 1.1 },
  },
};
